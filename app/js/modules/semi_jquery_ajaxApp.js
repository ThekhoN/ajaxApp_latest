...
var AjaxPageApp = (function(){
    ...
    public.init = function(options){
      if(!options){
        ...
        if(isUCBrowserX99 || (isIE_Browser < 11 && isIE_Browser > 0) || (isIE_mobileBrowser) || isAndroidV4 || isISMobile_Screen){
          nonPromise = true;
        }
        else {
          nonPromise = false;
        ...
        /*
        var run_jQueryEvents, loading_jQuery;
        var use_jQuery = false;
        run_jQueryEvents = function() {
          jQuery(document).ready(function() {
            ...
            //jquery events go here
              //jQuery_nonPromiseXHR.get(url_f, logData)
          });
        };
        ...
        loading_jQuery = function() {
          var jQ;
          if (!(typeof jQuery !== "undefined" && jQuery !== null)) {
            jQ = document.createElement('script');
            jQ.type = 'text/javascript';
            jQ.onload = jQ.onreadystatechange = run_jQueryEvents;
            jQ.src = 'https://ajax.googleapis.com/ajax/libs/jquery/2.2.4/jquery.min.js';
            return document.body.appendChild(jQ);
          } else {
            return run_jQueryEvents();
          }
        };

        function loading_jQueryIf_fn(){
          use_jQuery = nonPromise === true ? true : false;
          if(use_jQuery){
            console.log('load jQuery and run fn');
            listenLoading_jQuery();
          }
          else {
        ...
        function listenLoading_jQuery(){
          if (window.addEventListener) {
            window.addEventListener('load', loading_jQuery, false);
          } else if (window.attachEvent) {
            window.attachEvent('onload', loading_jQuery);
          }
        }
        loading_jQueryIf_fn();
        */
        ...
        //console.log('nonPromise after uA check: ', nonPromise);
        //startXHR start
        //dammit
        if(nonPromise !== true){
          promisefirstXHR_startReqRenderAndProceed(url);
        }
      //end of init
      };
    ...
    function jQuery_startReqRenderAndProceed(url_f) {
          jQuery_nonPromiseXHR.get(url_f, XHR_useFirstData);
    }
    ...
    function promisefirstXHR_startReqRenderAndProceed(url_f){
      //console.log('dom_targetIds_arr: ', dom_targetIds_arr);
      for(var i=0; i<dom_targetIds_arr.length; i++){
          dataContainerForRender.push([]);
          finalHTMLContent_arr.push([]);
      ...
      XHR_fastDomPromiseReqRender();
        ...
        function XHR_fastDomPromiseReqRender() {
              ...
              .then(function() {
                ...
                console.log('do not load blazy fucking hell');
                //init blazy
              ...
              .then(function(second_response) {
                ...
                if((isIE_Browser && isIE_Browser > 0)){
